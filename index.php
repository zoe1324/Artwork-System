...
<div class="container">
    <div class="page-header">
        <h1>Cara Art</h1>
        <button onclick="document.location='AdminPage.php'" class="btn btn-light">Admin</button>
    </div>
    ...
    <div class="select">
     <button onclick="document.location='TrackAndTrace.php'" class="btn btn-light">Track & Trace Bookings</button>
    </div>
</div>
</body>
</html>